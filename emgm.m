...
% modified by Willian Sun (691469063@qq.com).
% initialization
...
%calculate E-step in E-M algorithm
fprintf('step E\n');
mu = model.mu;
Sigma = model.Sigma;
w = model.weight;
...
parfor i = 1:k
    ...
    Sigma(:,:,i) = Xo*Xo'/nk(i);
    Sigma(:,:,i) = Sigma(:,:,i)+eye(d)*(1e-2); % add a prior for numerical stability
end
